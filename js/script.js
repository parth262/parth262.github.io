var audio = [new Audio("audio/Just The Way You Are.mp3"), new Audio("audio/Marvin Gaye.mp3"), new Audio("audio/talking to the moon.mp3"), new Audio("audio/see you again.mp3"), new Audio("audio/Vanilla Twilight.mp3"), new Audio("audio/Thinking Out Loud.mp3"), new Audio("audio/i wanna grow old with you.mp3"), new Audio("audio/when you say nothing at all.mp3")];
var index = 0;
